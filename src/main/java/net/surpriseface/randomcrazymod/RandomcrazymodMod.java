...
@Mod("randomcrazymod")
public class RandomcrazymodMod {
	public static final Logger LOGGER = LogManager.getLogger(RandomcrazymodMod.class);
	public static final String MODID = "randomcrazymod";
